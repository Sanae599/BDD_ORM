...
class UserBase(SQLModel, UserMixin, table=False):  # Ajout de UserMixin
    firstname: str
    lastname: str
...
class Trainer(UserBase, table=True):
    ...
    def get_id(self):
        return f"trainer:{self.id_trainer}"
...
class TeachingStaff(UserBase, table=True):
    ...
    def get_id(self):
        return f"teachingstaff:{self.id_teachingstaff}"
...
class Learner(UserBase, table=True):
    ...
    def get_id(self):
        return f"learner:{self.id_learner}"
